...
const Container = styled.div.attrs({
  className:
    'flex xl:mx-5 2xl:w-190 2xl:mx-auto items-center p-3 space-x-3 bg-neutral-0 rounded-xl border border-ui-100',
})`
  box-shadow:
...
const MobileModal = styled.div.attrs({
  className: `space-y-3 fixed bottom-2 z-50 p-2 mx-2 rounded-xl border border-ui-100 bg-neutral-0
