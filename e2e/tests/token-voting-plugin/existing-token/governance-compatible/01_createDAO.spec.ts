...
// Test is creating a Token Based DAO (existing governance compatible token) and opens the DAO dashboard
test('Create Token Based DAO (governance incompatible token)', async ({
  ...
  await page
    ...
    .fill('Token Based DAO (existing governance compatible token)');
