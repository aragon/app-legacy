...
export const UpdateVerificationCard: React.FC<UpdateVerificationCardProps> =
  () => {
    ...
    /** @todo Replace with real implementations and fetching from the back-end */
    const [daoAddress, isDaoAddressCheckLoading, isDaoAddressVerified] = [
      '0x999e89E75B3C49D3eF628f804F2c10e9A91F0C57',
      false,
      true,
    ];
    ...
    ] = ['0x999e89E75B3C49D3eF628f804F2c10e9A91F0C57', false, false];

    const [
      pluginSetupProcessorAddress,
      isPluginSetupProcessorCheckLoading,
      isPluginSetupProcessorVerified,
    ] = ['0x999e89E75B3C49D3eF628f804F2c10e9A91F0C57', true, false];
