...
export const TextareaSimple = styled.textarea.attrs({
  className: `py-1.5 px-2 rounded-xl resize-none w-full border-2 border-ui-100 hover:border-ui-300
    disabled:bg-neutral-100 disabled:border-ui-200 focus:ring-2 focus:ring-primary-500 focus:outline-none bg-white text-neutral-600 active:border-primary-500 active:ring-0`,
})`
  min-height: 144px;
